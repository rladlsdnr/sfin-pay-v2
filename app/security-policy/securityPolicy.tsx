    ...
    return (
        ...
        >
            ...
            <div className="max-w-4xl mx-auto text-center mb-16">
                ...
                <p className="mt-4 text-navy-800/80 text-lg leading-relaxed">
            ...
            {/* 본문 */}
            <div className="max-w-4xl mx-auto space-y-16 text-navy-900/90 leading-relaxed">
                {/* 1️⃣ 정보보호 정책 */}
                <section>
                    <h2 className="flex items-center gap-2 text-2xl font-bold mb-4 text-navy">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-navy-800/85">
                ...
                <section>
                    ...
                    <ul className="list-disc list-inside mt-2 text-navy-800/85">
                ...
                <p className="mt-16 text-sm text-navy/80 text-center">
