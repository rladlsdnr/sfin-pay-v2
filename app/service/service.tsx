...
export default function Service(): JSX.Element {
    ...
    return (
        <div className="min-h-screen bg-paper text-navy-900 pt-32">
            {/* HEADER */}
            <section className="text-center py-20 px-6 md:px-16 bg-gradient-to-b from-paper to-paper border-b border-mist/60">
                <motion.h1
            ...
            {/* FLOW DIAGRAM */}
            <section className="py-24 px-6 md:px-16 bg-paper border-b border-mist/50 relative overflow-hidden">
                <motion.h2
                    initial={{ opacity: 1, y: 30 }}
                    animate={{ opacity: mounted ? 1 : 0, y: mounted ? 0 : 30 }}
                    transition={{ duration: 0.6 }}
                ...
                >
                    ...
                    <motion.div
                        ...
                        <div className="w-24 h-24 rounded-2xl bg-white border border-mist flex items-center justify-center text-navy text-3xl shadow-md">
                            <ClipboardCheck />
                        </div>
                        <p className="font-semibold mt-2">예약 접수</p>
                        <p className="text-sm text-navy-800/70">고객 일정 및 예약 등록</p>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="flex flex-col items-center gap-2 w-32">
                        <div className="w-24 h-24 rounded-2xl bg-gradient-to-tr from-navy to-navy flex items-center justify-center text-white text-3xl shadow-[0_0_25px_rgba(0,51,102,0.25)]">
                            <CreditCard />
                        </div>
                        <p className="font-semibold mt-2">결제 진행</p>
                        <p className="text-sm text-navy-800/70">QR / 온라인 자동 결제</p>
                    </motion.div>
            ...
            {/* CTA */}
            <section className="py-24 px-6 md:px-16 bg-gradient-to-tr from-mist to-mist text-center border-t border-mist/50">
                <motion.h2
                    initial={{ opacity: 1, y: 20 }}
                    animate={{ opacity: mounted ? 1 : 0, y: mounted ? 0 : 20 }}
                    transition={{ duration: 0.6 }}
                ...
                <Link href="/inquiry/contract">
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="px-8 py-4 rounded-xl bg-navy hover:bg-navy-700 text-white font-semibold text-lg shadow-[0_8px_25px_rgba(0,51,102,0.25)] "
                    >
                        도입 상담 받기 →
                    </motion.button>
                </Link>
