 ...
 */
export default function TransparencyReport(): JSX.Element {
    useEffect(() => {
    ...
    const SectionTitle = ({
        ...
        <div className="text-center mb-12">
            {kicker && (
                <div className="text-xs font-semibold tracking-[0.18em] text-navy uppercase mb-2">
                    {kicker}
                </div>
            )}
            <h2 className="text-[26px] md:text-3xl font-extrabold text-navy-800 text-[clamp(24px,4vw,30px)]">
                {title}
            </h2>
            {sub && (
                <p className="mt-3 text-[15px] md:text-base text-navy-800/80 max-w-3xl mx-auto leading-relaxed">
                    {sub}
                </p>
            )}
        </div>
    ...
    const Pill = ({ children }: { children: React.ReactNode }) => (
        <span className="inline-flex items-center px-2.5 py-1 rounded-full bg-paper text-navy-900 text-[11px] font-medium border border-mist">
            {children}
        </span>
    );
    ...
    return (
        <div className="min-h-screen text-navy-800 pt-24 pb-24">
            ...
            <section className="text-center px-6 md:px-16 py-24  border-b border-mist">
                ...
                >
                    SFIN PAY{' '}
                    <span className="text-navy">투명경영 보고서 2025</span>
                </motion.h1>

                <motion.p
                    {...fadeUp(0.3)}
                    className="text-[15px] md:text-lg text-navy-700/80 max-w-3xl mx-auto leading-relaxed"
                >
            ...
            <section className="px-6 md:px-16 py-16">
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        {
                            icon: <HeartHandshake className="w-6 h-6 text-navy" />,
                            title: '상호 이익 구조',
                        ...
                        >
                            ...
                            <div className="font-semibold text-[15px] text-navy-800 mb-1">
                                {p.title}
                            </div>
                            <p className="text-[13px] text-navy-800/80 leading-relaxed">
                                {p.desc}
                            </p>
                        </motion.div>
                    ))}
            ...
            {/* ──────────────────────── ③ 지배구조 & 책임 ──────────────────────── */}
            <section className="px-6 md:px-16 py-16 bg-paper border-y border-mist">
                <SectionTitle
                    kicker="Governance"
                    title="지배구조와 책임 체계"
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6">
                    <motion.div {...fadeUp(0)} className="rounded-2xl bg-white p-6 border border-mist">
                        <div className="flex items-center gap-2 mb-3">
                            <Building2 className="w-5 h-5 text-navy" />
                            <h3 className="font-semibold text-[15px] text-navy-800">
                                경영위원회
                            </h3>
                        </div>
                        <p className="text-[13px] text-navy-800/80 mb-3">
                            회사의 중장기 전략, 신규 사업, 대규모 투자를 검토·의결하는 기구입니다.
                        </p>
                        <ul className="text-[13px] text-navy-800/85 space-y-1.5">
                    ...
                    <motion.div {...fadeUp(1)} className="rounded-2xl bg-white p-6 border border-mist">
                        <div className="flex items-center gap-2 mb-3">
                    ...
                    <motion.div {...fadeUp(2)} className="rounded-2xl bg-white p-6 border border-mist">
                        <div className="flex items-center gap-2 mb-3">
            ...
            <section className="px-6 md:px-16 py-16">
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-6">
                    <motion.div {...fadeUp(0)} className="rounded-2xl bg-white p-6 border border-mist">
                        ...
                        <ul className="text-[13px] text-navy-800/85 space-y-1.5 mb-3">
            ...
            <section className="px-6 md:px-16 py-16 bg-paper border-y border-mist">
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6">
                    {[
                        ...
                        <motion.div
                            key={m.label}
                            {...fadeUp(i)}
                            className="rounded-2xl bg-white p-6 border border-mist shadow-sm"
                        >
                            <div className="flex items-center justify-between mb-2">
                                <span className="text-[13px] text-[#64748B]">{m.label}</span>
                                <Activity className="w-4 h-4 text-navy" />
                            </div>
                            <div className="text-[24px] font-extrabold text-navy-800">
                                {m.value}
                            </div>
                            <p className="text-[12px] text-navy-800/80 mt-1">{m.desc}</p>
                        </motion.div>
                    ))}
                </div>
                ...
                <motion.div
                    {...fadeUp(3)}
                    className="max-w-6xl mx-auto mt-8 rounded-2xl bg-white p-6 border border-mist"
                >
                    <h3 className="text-[15px] font-semibold text-navy-800 mb-3 flex items-center gap-2">
                    ...
                    <div className="overflow-x-auto text-[13px]">
                        <table className="w-full border-collapse">
                            <thead>
                                <tr className="bg-paper text-navy-800">
                                    <th className="p-2 border border-mist">SEV</th>
                                    <th className="p-2 border border-mist">영향도</th>
                                    <th className="p-2 border border-mist">초동 대응 목표</th>
                                    <th className="p-2 border border-mist">커뮤니케이션 원칙</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td className="p-2 border border-mist text-center font-semibold text-[#DC2626]">
                                        SEV-1
                                    </td>
                                    <td className="p-2 border border-mist">
                                        대부분의 결제/정산 기능이 사용 불가
                                    </td>
                                    <td className="p-2 border border-mist">5분 이내 온콜·핫라인 가동</td>
                                    <td className="p-2 border border-mist">
                                        15분 이내 1차 공지, 30분 간격 진행 상황 공유
                                    </td>
                                </tr>
                                <tr className="bg-paper">
                                    <td className="p-2 border border-mist text-center font-semibold text-[#EA580C]">
                                        SEV-2
                                    </td>
                                    <td className="p-2 border border-mist">
                                        일부 가맹점·기능에서 지연·제한적 사용
                                    </td>
                                    <td className="p-2 border border-mist">15분 이내 대응 담당자 배정</td>
                                    <td className="p-2 border border-mist">
                                        30~60분 주기로 상태 페이지/알림 업데이트
                                    </td>
                                </tr>
                                <tr>
                                    <td className="p-2 border border-mist text-center font-semibold text-navy">
                                        SEV-3
                                    </td>
                                    <td className="p-2 border border-mist">
            ...
            <section className="px-6 md:px-16 py-16">
                ...
                <motion.div
                    {...fadeUp(2)}
                    className="max-w-5xl mx-auto mt-8 rounded-2xl bg-white p-6 border border-mist"
                >
                    <h3 className="text-[15px] font-semibold text-navy-800 mb-3 flex items-center gap-2">
                        <Layers className="w-4 h-4 text-navy" />
                        인시던트 타임라인 예시 (공개용 서술 포맷)
                    </h3>
                    <ol className="text-[13px] text-navy-800/85 space-y-2">
                        <li>
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6">
                    <motion.div {...fadeUp(0)} className="rounded-2xl bg-white p-6 border border-mist">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <h3 className="text-[15px] font-semibold text-navy-800">데이터 보호</h3>
                        </div>
                        <ul className="text-[13px] text-navy-800/85 space-y-1.5">
                    ...
                    <motion.div {...fadeUp(1)} className="rounded-2xl bg-white p-6 border border-mist">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <h3 className="text-[15px] font-semibold text-navy-800">내부 통제</h3>
                        </div>
                        <ul className="text-[13px] text-navy-800/85 space-y-1.5">
            ...
            <section className="px-6 md:px-16 py-16 bg-paper border-y border-mist">
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6">
                    <motion.div {...fadeUp(0)} className="rounded-2xl bg-white p-6 border border-mist">
                        <div className="flex items-center gap-2 mb-3">
                            <Globe2 className="w-5 h-5 text-navy" />
                            <h3 className="text-[15px] font-semibold text-navy-800">환경(E)</h3>
                        </div>
                        <ul className="text-[13px] text-navy-800/85 space-y-1.5">
                    ...
                    <motion.div {...fadeUp(1)} className="rounded-2xl bg-white p-6 border border-mist">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <h3 className="text-[15px] font-semibold text-navy-800">사회(S)</h3>
                        </div>
                        <ul className="text-[13px] text-navy-800/85 space-y-1.5">
                    ...
                    <motion.div {...fadeUp(2)} className="rounded-2xl bg-white p-6 border border-mist">
                        <div className="flex items-center gap-2 mb-3">
                            <Scale className="w-5 h-5 text-navy" />
                            <h3 className="text-[15px] font-semibold text-navy-800">지배구조(G)</h3>
                        </div>
                        <ul className="text-[13px] text-navy-800/85 space-y-1.5">
            ...
            {/* ──────────────────────── ⑪ 마무리 CTA ──────────────────────── */}
            <section className="px-6 md:px-16 pt-8 pb-24 bg-gradient-to-r from-paper to-mist border-t border-mist">
                <motion.div
                    {...fadeUp(0)}
                    className="max-w-4xl mx-auto text-center space-y-4"
                >
                    <h2 className="text-[clamp(24px,4vw,30px)] font-extrabold text-navy-800">
                        더 깊이 있는 자료가 필요하신가요?
                    </h2>
                    <p className="text-[14px] md:text-[15px] text-navy-700/85 leading-relaxed">
