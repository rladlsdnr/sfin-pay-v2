        ...
        >
            ...
            <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between gap-10">
                {stages.map((s, i) => {
                    ...
                    // ✅ 모바일: 모두 동일한 높이 고정
                    // ✅ 데스크탑(md 이상): 자동 높이 + 최소 높이만 지정
                    const baseCard =
                        'relative flex-1 p-6 rounded-2xl border backdrop-blur-sm duration-500 ' +
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* ✅ 하단 메타 정보: absolute로 고정 위치에 배치 (높이 변동 없음) */}
